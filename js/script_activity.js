...
function MG_Me(mg) {
	...
	this.emotions = {
		...
		happy: "images/me_happy.png",
		unhappy: "images/me_unhappy.png",
		surprised: "images/me_surprised.png",
		tongue: "images/me_tongue.png"
	};
	//魔改-----------
	try{
		clearInterval(timer);
...
MG_Me.prototype = {
	init: function () {
		...
		tmpImg.setAttribute("src", "images/me.png");
		this.meImg = tmpImg;
		...
		this.itvl = setInterval(function () {
			if (!_this.mg.isMoved) return;
			var now = new Date();
			if (now - _this.lastMove > 10000 && _this.finished == false) {
				_this.inform("Hello?");
